...
function addList(task) {
    ...
    li.innerHTML = "<span class=\"deletetodo\"><i class=\"far delete fa-trash-alt\"></span></i><input class=\"newtodo\" type=\"checkbox\"><label class=\"nameElement\">".concat(task, "</label>"); //auch ->` + task + ` <- möglich
    ul.appendChild(li);
